...
def insert_data():
    ...
    for i in range(1000000):
        person_info = (
        faker.phonenumber_prefix(),faker.phone_number(),faker.ean8(),faker.ean8(),faker.ean8(),faker.name(), faker.ssn(), faker.job(), faker.address(), faker.url(), faker.ascii_email(), faker.date(),
